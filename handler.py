...
def get_video_data(filename, subfolder, video_type):
    ...
    url_values = urllib.parse.urlencode(data)
    try:
        # Use requests for consistency and timeout - videos might be larger, so use longer timeout
        ...
        for node_id, node_output in outputs.items():
            ...
            if "gifs" in node_output:
                ...
                for video_info in node_output["gifs"]:
                    ...
                    video_bytes = get_video_data(filename, subfolder, video_type)
